...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 52323 or testnet: 42323)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 52323 or testnet: 42323)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Faircoin Wiki for SSL setup instructions)") + "\n" +
